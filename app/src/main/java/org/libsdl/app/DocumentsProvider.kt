 ...
 * Copyright © 2024 kuwoh Used on unnamed sdvx clone
 *
...
package com.example.unnamed_sdvx_clone;
...
class DocumentsProvider : DocumentsProvider() {
   ...
   // private val baseDirectory = touchHLEApplication.getContext().getExternalFilesDir(null)!!
    ...
    companion object {
        ...
        const val AUTHORITY : String = "com.com.example.unnamed_sdvx_clone.provider"
